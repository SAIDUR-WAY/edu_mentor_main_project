...
//     <Image width={190} height={256} className="object-cover w-full shadow-2xl md:h-auto " src={image_url} alt="Tutor_image"/>
...
//            <p> null</p>
//            <p> {
//                 tuition_info?.preferred_areas_to_teach?.map((area: any, index: any)=> <span
//                  key={index}
//                  className="pr-2"
//                  >
